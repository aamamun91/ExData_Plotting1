...
layout(m)
plot(energy$datetime, energy$g_act_pow, type="l", col="black", main=NULL, xlab=" ", ylab="Global Active Power")
plot(energy$datetime, energy$volt, type="l", col="black", main=NULL, xlab="datatime ", ylab="Voltage")
...
plot(energy$datetime, energy$g_react_pow, type="l", col="black", main=NULL, xlab="datatime ", ylab="Global_reactive_power")
